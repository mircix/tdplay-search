...
";
  ...
  var ICONS = {
    ...
    apple: '<svg viewBox="4.5 3.5 16 16"><polygon points="9.7,7.4 18.4,5.4 18.4,8.2 9.7,10.2"/><rect x="9.7" y="7.4" width="1.3" height="9.4"/><rect x="17.1" y="5.4" width="1.3" height="9.4"/><ellipse cx="8.4" cy="16.9" rx="2.5" ry="1.8" transform="rotate(-20 8.4 16.9)"/><ellipse cx="15.8" cy="14.9" rx="2.5" ry="1.8" transform="rotate(-20 15.8 14.9)"/></svg>',
